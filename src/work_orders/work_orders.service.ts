...
export class WorkOrdersService {
    ...
    async create(dataDto: CreateWorkOrderDto, user: users, work_evidences: Array<Express.Multer.File>) {
    ...
    async update(id: number, dataDto: UpdateWorkOrderDto, user: users, work_evidences: Express.Multer.File[]) {
        const { id: user_id } = user
